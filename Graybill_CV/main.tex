...
\begin{flushright}
  \setstretch{0.6}
  \item {\ttfamily aaron[dot]graybill[at]stanford.edu}  % E-mail address
  % In this monospace face, the email tail after "aaron" is 17 characters
  % longer than the URL tail. The invisible 17-character suffix aligns them.
  \item {\ttfamily \url{https://aarongraybill.com}\hphantom{[dot][at]stanford}}
\end{flushright}\vspace{-45pt}

\begin{flushleft}  % Rplace here with your name (and identity if required)
  {\Atkinson \fontsize{30pt}{30pt}\selectfont Aaron Graybill}
...
\itemListStart
  \namedItem{Relevant Coursework: }{Microeconomics Sequence, Econometrics Sequence}
\itemListEnd
...
\itemListStart
\myItem{
    Terminal undergraduate microeconomics
}
\itemListEnd
