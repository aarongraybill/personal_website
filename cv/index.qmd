...
(Undergraduate Thesis) **Graybill, A.** "Exposure Doesn’t Pay the Bills
Artistic Production on Streaming Platforms Under Algorithmically-Induced Audience
Uncertainty"
...
For outstanding senior theses in economics. [My thesis](../assets/Graybill_Undergraduate_Thesis.pdf) was one of three selected as finalists for the award.
...
**Programming:** R, Python, Julia, SQL, Stata, Visual Basic
